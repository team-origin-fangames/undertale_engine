...
var inst = Battle_CreateBone(bone_x, battle_board.y - battle_board.up, bone_hspeed, 0, bone_length, -90, bone_outside, bone_no_bottom, bone_auto_destroy_dir, bone_type, bone_auto_destroy, BATTLE_BULLET_BONE_ORIGIN.BOTTOM_CENTER, bone_rotate, bone_rotate_angle, bone_existence_time);
