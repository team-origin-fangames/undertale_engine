...
{
	bone[process] = instance_create_depth(battle_board.x - battle_board.left + i, battle_board.y + battle_board.down + bone_length, 0, battle_bullet_bone);
	...
	bone[process]._auto_destroy_direction = DIR.DOWN;
...
var bone_warning = instance_create_depth(battle_board.x - battle_board.left + 1, battle_board.y + battle_board.down - bone_length, 0, battle_warning);
bone_warning._width = battle_board.left + battle_board.right - 2;
bone_warning._height = battle_board.down + 1;
