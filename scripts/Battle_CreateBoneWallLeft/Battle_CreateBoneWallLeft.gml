...
{
	bone[process] = instance_create_depth(battle_board.x - battle_board.left - bone_length, battle_board.y - battle_board.up + i, 0, battle_bullet_bone);
