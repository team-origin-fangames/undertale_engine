...
var inst = Battle_CreateBone(battle_board.x - battle_board.left, bone_y, 0, bone_vspeed, bone_length, 0, bone_outside, bone_no_bottom, bone_auto_destroy_dir, bone_type, bone_auto_destroy, BATTLE_BULLET_BONE_ORIGIN.BOTTOM_CENTER, bone_rotate, bone_rotate_angle, bone_existence_time);
