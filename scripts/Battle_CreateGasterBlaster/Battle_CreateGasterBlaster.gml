...
inst.x_target = gb_x_target;
inst.y_target = gb_y_target;
inst.angle_start = gb_angle_start;
inst.angle_target = gb_angle_target;
inst.scale_x = gb_scale_x;
inst.scale_y = gb_scale_y;
inst.type = gb_type;
inst.time_fire_delay = gb_fire_delay;
inst.time_fire_stay = gb_fire_stay;
inst.time_beam_end_delay = gb_end_delay;
